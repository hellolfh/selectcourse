...
DROP TABLE IF EXISTS `CourseChoose`;
...
CREATE TABLE `CourseChoose` (
  ...
  `selected` int(5) NOT NULL,
  PRIMARY KEY (`id`)
  unique key (`teacherNumber`, `courseNumber`)
...
LOCK TABLES `CourseChoose` WRITE;
/*!40000 ALTER TABLE `Course_choose` DISABLE KEYS */;
INSERT INTO `CourseChoose` VALUES
(1,2018100004,1001,1),
(2,2018100004,1002,1),
(3,2018100004,1003,1),
(4,2018100004,1004,1),
