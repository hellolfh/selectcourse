...
<rapid:override name="content">
    ...
    <div style="width:600px; height:450px; margin:100px 350px; border:3px solid gray;">
        ...
        <div>
            <input type="text" onclick="setSelectTime()" class="layui-btn layui-btn-lg layui-btn-warm" style="margin-top:15px;">
            </input>
        </div>

        <form class="setSelectTime-form" id="setSelectTime" method="post" action="<%=basePath%>user/setSelectTime" style="margin:80px 400px; width:450px;">
