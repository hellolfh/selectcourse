...
<body>
<div class="formdiv">
    <form id="contact" action="<%=basePath%>user/check" method="post">
        <h3>选课系统</h3>
        <h4>第一次登陆后请尽快更改初始密码</h4>
        <h4 style="color:red;">${msg}</h4>
        <fieldset>
            <input placeholder="学号" type="text" name="teacherNumber" id="teacherNumber" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
            <input placeholder="密码" type="password" name="pass" tabindex="2" required>
        </fieldset>
        <fieldset>
